...
/**
 * The About page's standing, and how to reach the place.
 */
class About_Detail extends Base_Widget {
	...
	public function get_title() {
		return esc_html__( 'About — Detail', 'custom-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return array( 'about', 'detail', 'location', 'contact', 'map' );
	}
	 ...
	 */
	private function register_place_controls() {
		$design = $this->design_text();
		...
		foreach ( array(
			'location' => esc_html__( 'Location', 'custom-elementor-widgets' ),
	...
	private function register_style_controls() {
		...
		$this->add_group_control(
			...
			array(
				...
				'label'          => esc_html__( 'Heading beside the map', 'custom-elementor-widgets' ),
		...
		$this->add_control(
			'mark_background',
			array(
				'label'     => esc_html__( 'Contact marks', 'custom-elementor-widgets' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#3A2114',
				'separator' => 'before',
				'selectors' => array(
					'{{WRAPPER}} .custom-about-detail__contact-mark' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			'mark_color',
			array(
				'label'     => esc_html__( 'Contact marks, inside', 'custom-elementor-widgets' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#FFFFFF',
				'selectors' => array(
					'{{WRAPPER}} .custom-about-detail__contact-mark svg' => 'fill: {{VALUE}};',
				),
			)
		);
		...
		<div class="custom-about-detail">
			...
			<div class="custom-about-detail__split">
				<div class="custom-about-detail__column">
					...
					<div class="custom-about-detail__block">
						<h3><?php echo esc_html( $this->text( $settings, 'hours_title' ) ); ?></h3>

						<?php foreach ( $hours as $hour ) : ?>
							<div class="custom-about-detail__hours">
								<p class="custom-about-detail__hours-name"><?php
									echo esc_html( isset( $hour['name'] ) ? $hour['name'] : '' );
								?></p>
								<p class="custom-about-detail__hours-time"><?php
					...
					<div class="custom-about-detail__block">
						...
						<div class="custom-about-detail__contacts">
							<?php foreach ( array( 'phone', 'email', 'chat' ) as $which ) : ?>
								<?php
								...
								?>
								<a class="custom-about-detail__contact"<?php
								...
								?>>
									<span class="custom-about-detail__contact-mark" aria-hidden="true"><?php $this->render_mark( $which ); ?></span>
