...
/**
 * The Dining page's food menu section.
 */
class Dining_Food_Menu extends Base_Widget {
	...
	public function get_title() {
		return esc_html__( 'Dining — Food Menu', 'custom-elementor-widgets' );
	}
	...
	public function get_keywords() {
		return array( 'dining', 'food', 'menu', 'pdf' );
	}
	...
	protected function design_text() {
		return array(
			'heading'     => esc_html__( 'Dining at CAVO', 'custom-elementor-widgets' ),
			'body'        => esc_html__( 'At CAVO, every dish and pour follows The Journey of Discovery — a culinary route across the Mediterranean Cultural Triad. From the bright citrus ease of Southern Europe, to the warm spice trails of Western Asia, to the bold, fiery flavours of North Africa, our menu is a passage through three civilisations sharing one sea.', 'custom-elementor-widgets' ),
			'button_text' => esc_html__( 'View food menu', 'custom-elementor-widgets' ),
		);
	}
	...
	private function register_style_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#3A2114',
				'selectors' => array(
					'{{WRAPPER}} .custom-dining-menu' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'          => esc_html__( 'Heading', 'custom-elementor-widgets' ),
				'selector'       => '{{WRAPPER}} .custom-dining-menu__heading',
		...
		$this->add_group_control(
			...
			array(
				...
				'label'          => esc_html__( 'Text', 'custom-elementor-widgets' ),
				'selector'       => '{{WRAPPER}} .custom-dining-menu__body',
				'fields_options' => array(
					'typography'  => array( 'default' => 'yes' ),
		...
		$this->add_group_control(
			...
			array(
				...
				'selector'       => '{{WRAPPER}} .custom-dining-menu__button',
				'fields_options' => array(
					'typography'  => array( 'default' => 'yes' ),
					'font_family' => array( 'default' => 'Roboto' ),
					'font_size'   => array(
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#FFFFFF',
				'selectors' => array(
					'{{WRAPPER}} .custom-dining-menu__button' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#3A2114',
				'selectors' => array(
					'{{WRAPPER}} .custom-dining-menu__button' => 'background-color: {{VALUE}};',
				),
			)
		);
	...
	protected function render() {
		...
		?>
		<div class="custom-dining-menu">
			<div class="custom-dining-menu__column">
				<<?php echo esc_attr( $tag ); ?> class="custom-dining-menu__heading"><?php
					echo esc_html( $this->text( $settings, 'heading' ) );
				?></<?php echo esc_attr( $tag ); ?>>

				<p class="custom-dining-menu__body"><?php
